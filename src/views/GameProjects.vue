<template>
  <div class="game-projects-page">
    <div class="page-header">
      <h1 class="page-title">Game Projects</h1>
      <p class="page-description">
        A collection of games I've developed and contributed to, showcasing my expertise in Unity game development, gameplay systems, and player experience design.
      </p>
    </div>
